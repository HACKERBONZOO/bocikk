module.exports = {
    ...
    <div>
      ...
      <div style="width: 95%;">
      Youtube Search:<br>
      <textarea id="vidname" rows="2" placeholder="Write a video name here or use variables..." style="width: 95%; font-family: monospace; white-space: nowrap; resize: none;"></textarea>
      </div> <br>
