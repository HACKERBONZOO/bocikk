module.exports = {
    ...
    action: async function(cache) {
        ...
        if (!videourl) return console.log("${data.name}: Please specify a video url to get video informations.");
		if (!apikey) return console.log("${data.name}: Please get your key from Google and write it in the field.");
